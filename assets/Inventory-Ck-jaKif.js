import { c as createLucideIcon, j as jsxRuntimeExports, T as TriangleAlert, r as reactExports, i as useInventory, X, p as Sparkles, m as api, P as Package, q as useSearchParams, o as Trash2, t as Search } from "./index-CbpJklZT.js";
import { A as AddStockModal } from "./AddStockModal-DkflPypb.js";
...
import "./dollar-sign-t5bnA7f3.js";
/**
...
const Inventory = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-8 animate-in fade-in duration-500 pb-20", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white/70 backdrop-blur-xl p-4 rounded-3xl shadow-soft border border-gray-100 flex flex-col lg:flex-row gap-4 sticky top-0 z-20", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex-1", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            ...
            className: "w-full pl-12 pr-4 py-3 bg-white border border-gray-200 rounded-2xl focus:outline-none focus:ring-4 focus:ring-primary-100 focus:border-primary-400 transition-all font-medium",
            value: searchTerm,
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex gap-2 overflow-x-auto pb-1 scrollbar-hide lg:pb-0", children: categories.map((cat) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        "button",
        {
          ...
          className: `px-4 py-3 rounded-xl text-sm font-bold whitespace-nowrap transition-all ${selectedCategory === cat ? "bg-primary text-primary-foreground shadow-md shadow-primary/20" : "bg-transparent text-gray-500 hover:bg-gray-100"}`,
          children: cat
        },
        cat
      )) }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          ...
          className: "flex items-center gap-2 px-6 py-3 rounded-2xl bg-primary text-primary-foreground font-bold shadow-lg hover:opacity-90 transition-all hover:scale-105 active:scale-95 whitespace-nowrap flex-shrink-0",
          children: [
    ...
    filteredProducts.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center py-20 flex flex-col items-center justify-center opacity-50", children: [
    ...
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 2xl:grid-cols-4 gap-6", children: filteredProducts.map((product) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "group bg-white rounded-3xl p-4 border border-gray-100 shadow-sm hover:shadow-xl hover:border-primary-100 transition-all duration-300 relative overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-24 h-24 bg-gray-50 rounded-2xl flex-shrink-0 overflow-hidden relative", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0 flex flex-col justify-between py-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-between items-start", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-bold text-gray-900 line-clamp-2 leading-tight mb-1", children: product.name }) }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold text-gray-400 uppercase tracking-wider", children: product.category || "Uncategorized" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-end justify-between", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-gray-400 font-medium mb-0.5", children: "Price" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-lg font-black text-black", children: [
              "LKR ",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-4 pt-4 border-t border-gray-50 flex items-center justify-between", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-2", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `px-2.5 py-1 rounded-lg text-xs font-bold flex items-center gap-1.5 ${product.stock < 10 ? "bg-red-50 text-red-600" : "bg-green-50 text-green-600"}`, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `w-2 h-2 rounded-full ${product.stock < 10 ? "bg-red-500" : "bg-green-500"}` }),
